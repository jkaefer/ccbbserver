...
from regsnp_intron.utils.vcf import VCF
from regsnp_intron.utils.seq import FlankingSeq
from regsnp_intron.utils.snp import SNP
from regsnp_intron.utils.annovar import Annovar
from regsnp_intron.utils.closest_exon import ClosestExon
from regsnp_intron.rbp.rbp_change import RBPChange
from regsnp_intron.protein_feature.protein_feature import ProteinFeature
from regsnp_intron.junc_score.junction_strength import JunctionStrength
from regsnp_intron.conservation.phylop import Phylop
...
class FeatureCalculator(object):
    ...
    def calculate_feature(self):
        ...
        #phylop_fname = os.path.join(self.db_dir, '/home/pcuser/Documents/microblog/app/regsnp-intron/data/regsnp_intron_web/phylop/hg19.100way.phyloP100way.bw')
        phylop = Phylop('/N/slate/jkaefer/introndb/phylop/hg19.100way.phyloP100way.bw')
        phylop.calculate(os.path.join(out_dir_tmp, 'snp.distance'), os.path.join(out_dir_tmp, 'snp.phylop'))
        phylop.close()
        self.logger.info('Made to other side.')

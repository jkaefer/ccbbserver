...
class DB(object):
    ...
    def query_structure(self, transcript_id):
        ...
        if r:
            ...
            structure_info['beta_sheet'] = list(map(float, r[0]['beta_sheet'].split(',')))
            structure_info['random_coil'] = list(map(float, r[0]['random_coil'].split(',')))
            structure_info['alpha_helix'] = list(map(float, r[0]['alpha_helix'].split(',')))
            structure_info['asa'] = list(map(float, r[0]['asa'].split(',')))
            structure_info['disorder'] = list(map(float, r[0]['disorder'].split(',')))

...
ss.list = read.table("./regsnps-splicing/source/code_package/model/ss.featureList", header=F, sep="", quote="")
...
out.data.neu = out.data.neu[, -c(15,16,17,18)]
...
eb.list = read.table("./regsnps-splicing/source/code_package/model/exonbody.featureList", header=F, sep="", quote="")

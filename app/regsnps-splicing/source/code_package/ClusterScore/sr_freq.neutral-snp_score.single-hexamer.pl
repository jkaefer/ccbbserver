...
open (IN, $infile)||die "$!";
open (OUT, ">$regfl.motif_cluster.score")||die "$!";
...
open (GA, ">$regfl.ESR.gain.location.count")||die "$!";
...
open (LO, ">$regfl.ESR.loss.location.count")||die "$!";
...
open (GA, ">$regfl.ESR.gain-loss.count")||die "$!";
...
open (GA, ">$regfl.snp-affected-motif")||die "$!";

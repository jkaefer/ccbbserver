...
my $status = `perl ./regsnps-splicing/source/code_package/PrepareSeq/extract_target_sequence.pl $infile $desp $archive`;
print LOG "\n$status\n";

# exon/intron length
print LOG "......(2/9) calculating length of exon and neighboring introns......\n";
$status = `perl ./regsnps-splicing/source/code_package/ExonIntronLen/exon_intron_length.pl $desp $archive`;
print  LOG "<p>$status</p>\n";

# SR_protein matching score
print LOG "......(3/9) calculating Splicing factor binding affinity score......\n";
$status = `perl ./regsnps-splicing/source/code_package/SFProtein/SR_protein.score.pl /N/slate/jkaefer/splicingdb/motif/SRSF1.pssm $desp $archive`;
print  LOG "<p>$status</p>\n";
$status = `perl ./regsnps-splicing/source/code_package/SFProtein/SR_protein.score.pl /N/slate/jkaefer/splicingdb/motif/SRSF2.pssm $desp $archive`;
print  LOG "<p>$status</p>\n";
$status = `perl ./regsnps-splicing/source/code_package/SFProtein/SR_protein.score.pl /N/slate/jkaefer/splicingdb/motif/SRSF5.pssm $desp $archive`;
print  LOG "<p>$status</p>\n";
$status = `perl ./regsnps-splicing/source/code_package/SFProtein/SR_protein.score.pl /N/slate/jkaefer/splicingdb/motif/SRSF6.pssm $desp $archive`;
print  LOG "<p>$status</p>\n";

# junction score
print LOG "......(4/9) calculating junction score of SNPs affected exons......\n";
$status =  `perl ./regsnps-splicing/source/code_package/JunctionScore/junction_score.pl $desp $archive`;
print  LOG "<p>$status</p>\n";

#evolution
print LOG "......(5/9) calculating the average conservation score(Phylop) for +/- 5bp around SNP......\n";
$status =  `perl /N/slate/jkaefer/splicingdb/phylop_score/acess.phylop.pl $desp.snp.ref.mut.seq.mutBed $archive`;
print  LOG "<p>$status</p>\n";

#all RBP
print LOG "......(6/9) calculating the effect of distuptions in RNA binding proteins(RBPs)......\n";
$status =  `perl ./regsnps-splicing/source/code_package/RBP/cal_RBP_matching_score.pl $desp.snp.ref.mut.seq $archive`;
print  LOG "<p>$status</p>\n";
$status =  `Rscript ./regsnps-splicing/source/code_package/RBP/magnitude_postProb.r $desp.snp.ref.mut.seq $archive`;
print  LOG "<p>$status</p>\n";

##cluster score & ESR-HS score
print LOG "......(7/9) calculating the disruption of ESE/ESS in exons......\n";
$status =  `perl ./regsnps-splicing/source/code_package/ClusterScore/cluster_score.pl $desp.snp.ref.mut.seq $archive`;# generate cluster score
print  LOG "<p>$status</p>\n";

print LOG "......(8/10) RNA 2nd structure and structure distance......\n";
$status =  `perl ./regsnps-splicing/source/code_package/EFScore/compute_ef_score_around_snp.pl $desp.snp.ref.mut.seq $archive`;
print  LOG "<p>$status</p>\n";
$status =  `perl ./regsnps-splicing/source/code_package/RNAstructure/structure_distance.pl $desp $archive`;
print  LOG "<p>$status</p>\n";
...
$status =  `perl ./regsnps-splicing/source/code_package/PfamPTMDisorder/pfam_ptm_disorderScore.pl $desp.snp.ref.mut.seq $archive`;
print  LOG "<p>$status</p>\n";
...
$status =  `Rscript ./regsnps-splicing/source/code_package/ASASS/norm_asa_ss.r $desp $archive`;
print LOG "<p>$status</p>\n";
...
$status =  `Rscript ./regsnps-splicing/source/code_package/generate_all_neutral_data_add_features.r $desp $archive`;
print LOG "<p>$status</p>\n";
...
if($var_c >0){
	$status = `./regsnps-splicing/source/code_package/model/roc.test_neutral.sh ./regsnps-splicing/source/code_package/model/combined_model_4 $archive/$desp.weka.data.inner.pred.arff $desp.exonBody $archive 2>&1`;
...
#	print LOG "./regsnps-splicing/source/code_package/model/roc.test.sh ./regsnps-splicing/source/code_package/model/ss.4.model $archive/$desp.weka.data.ss.pred.arff $desp.splicingSite $archive 2>&1\n";
	$status =  `./regsnps-splicing/source/code_package/model/roc.test.sh ./regsnps-splicing/source/code_package/model/ss.4.model $archive/$desp.weka.data.ss.pred.arff $desp.splicingSite $archive 2>&1`;
